...
export function RulesModal() {
    return (
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[600px] max-h-[85vh] p-0 overflow-hidden flex flex-col border-none shadow-2xl">
                    ...
                    <div className="p-6 space-y-8 pb-4">
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                <div className="p-4 rounded-xl border bg-slate-50 dark:bg-slate-800/50 space-y-2">
                                    ...
                                    <p className="text-xs font-medium">Stock price increases by the rolled amount (5, 10, or 20 cents).</p>
                                </div>
                                <div className="p-4 rounded-xl border bg-slate-50 dark:bg-slate-800/50 space-y-2">
                                    <Badge variant="destructive">DOWN</Badge>
                                    <p className="text-xs font-medium">Stock price decreases by the rolled amount. Prices cannot go below $0.00.</p>
                                </div>
                                <div className="p-4 rounded-xl border bg-slate-50 dark:bg-slate-800/50 space-y-2">
                                    <Badge className="bg-blue-500 hover:bg-blue-600">DIVIDEND</Badge>
                                    <p className="text-xs font-medium">Pays cash to all owners of that stock. Only values **&gt; $1.00** pay out.</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="space-y-3">
                                <div className="flex gap-4 items-start p-4 rounded-xl border border-yellow-200/50 bg-yellow-50/30 dark:bg-yellow-900/10">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground mt-1">When a stock hits **$2.00**, it splits! Your share count **doubles**, and the price resets to **$1.00**. This is how you grow big portfolios quickly.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 items-start p-4 rounded-xl border border-red-200/50 bg-red-50/30 dark:bg-red-900/10">
                                    <div className="bg-red-100 dark:bg-red-900/30 p-2 rounded-lg text-red-700 dark:text-red-400">
                                        <AlertTriangle className="h-5 w-5" />
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-sm uppercase">Bankruptcy ($0.00)</h4>
                                        <p className="text-xs text-muted-foreground mt-1">If a stock drops to **$0.00**, it goes bankrupt. All shares of that stock are **wiped out** (set to 0), and the price resets to **$1.00**.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                ...
                <div className="p-6 pt-2 shrink-0 border-t bg-slate-50 dark:bg-slate-800/30">
                    <Button onClick={() => document.querySelector('[data-slot="dialog-close"]')?.dispatchEvent(new MouseEvent('click', { bubbles: true }))} className="w-full h-11 font-bold uppercase tracking-wider rounded-xl">
                        Got it, Let's Play!
                    </Button>
                </div>
            </DialogContent>
